...
public class BookHotelService : IBookHotelService
{
    ...
    public BookHotelService(INotificationClient notificationClient, ILogger<BookHotelService> logger)
    {
    ...
    public async Task<BookingResponse> CreateBookingAsync(CreateBookingRequest request, int? userId = null)
    {
        ...
        try
        {
            ...
            var notificationSent = await _notificationClient.SendBookingConfirmationAsync(booking);
    ...
    public async Task<BookingResponse> CancelBookingAsync(int bookingId, string? cancellationReason = null)
    {
        ...
        try
        {
            ...
            var notificationSent = await _notificationClient.SendBookingCancellationAsync(booking);
